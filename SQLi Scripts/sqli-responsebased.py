...
def sqli_password(url):
    password_extracted = ""
    for i in range (1,21): #This is the range/length of our password, and so if our password length was 20, we would have to make it 1 larger.
